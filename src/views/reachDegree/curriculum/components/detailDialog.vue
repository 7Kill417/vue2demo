<template>
    <div>
        ...
        <el-dialog
            ...
            <div>
                <el-form ref="fromData" :model="fromData" label-width="150px">
                    <el-form-item label="学生编码:" prop='stuNo'>
                        <el-input v-model="fromData.stuNo" :disabled='true'></el-input>
                    </el-form-item>
                    <el-form-item label="学生名称:" prop='studentName'>
                        <el-input v-model="fromData.studentName"></el-input>
                    </el-form-item>
                    <!-- <el-form-item label="教学目标成绩:" prop='achieveLevel'> 
                        <el-input v-model="fromData.achieveLevel"></el-input>
                    </el-form-item>
                    <el-form-item label="教学目标对应指标点1:" prop='kpi'> 
